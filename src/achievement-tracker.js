 ...
 * Shows badge progress for README Badge Gen and a Day 1 -> Month 1 roadmap.
 * Usage:
...
function printBadgeTable() {
  console.log('=== README Badge Gen — Achievement Badge Progress ===\n');
...
function printRoadmap() {
  console.log('=== README Badge Gen — Day 1 -> Month 1 Roadmap ===\n');
  const roadmap = [
